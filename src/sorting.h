...
/*
    ...
    Critério default: compara coordenadas y; se empatar compara x e para segundo
   desempate, a área Critérios cor de preenchimento: compara os valores RGB da
   cor. Primeiro RED, depois GREEN para desempate e BLUE para segundo desempate
*/
