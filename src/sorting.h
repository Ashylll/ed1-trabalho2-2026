...
/*
    sorting.h
    Módulo responsável pela comparação e ordenação de formas

    Possui funções de comparação segundo critérios diferentes
    Possibilita a ordenação de formas em vetores, gerando SVGs sucessivos a fim de criar uma animação do processo
...
/// @pre comb_out != NULL && vetor != NULL && cmp != NULL
