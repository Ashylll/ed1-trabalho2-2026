...
void setUp(void) {
  ...
  // Figura 2: Retângulo (Âncora canto sup. esquerdo em X=90, Y=40. Altura=20,
  // Largura=30)
  fprintf(fp_geo, "r 2 90.0 40.0 30.0 20.0 black yellow\n");

  // Figura 3: Linha (Ponto inicial em X=150, Y=40. Linha vertical descendo até
  // Y=80)
  ...
  // Figura 7: Linha (Ponto inicial em X=390, Y=40. Linha inclinada até X=410,
  // Y=90)
...
void teste_bubble_sort_animado(void) {
  ...
  Forma ret_sel = cria_forma(
      'r', cria_retangulo(-1, 0.0, 0.0, 200.0, 200.0, "red", "none"));
