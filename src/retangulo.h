...
/*
    ...
    -   O retângulo é um conjunto de quatro pontos no plano cartesiano, dos
   quais é possível traçar dois pares de segmentos paralelos, formando a figura
   geométrica;
    -   Possui identificador de número inteiro;
    -   Possui coloração para a borda (segmentos) e o seu preenchimento (dentro
   dos limites do retângulo) de acordo com o padrão SVG.
...
/// @brief cria um retângulo com identificador, cor de borda e de preenchimento
/// e coordenadas âncora
...
/// @return ponteiro para o retângulo; NULL se parâmetros inválidos ou falha de
/// memória
...
/// @return true se a operação foi bem sucedida; false se r == NULL || corb ==
/// NULL
...
/// @return true se a operação foi bem sucedida; false se r == NULL || corp ==
/// NULL
